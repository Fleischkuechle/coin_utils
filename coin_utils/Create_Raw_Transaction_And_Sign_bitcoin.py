...
class Create_Raw_Transaction_And_Sign_bitcoin:
    def __init__(
        self,
        # coin_symbol: str,
        testnet: bool = False,
...
if __name__ == "__main__":
    create_raw_transaction_and_sign_bitcoin: Create_Raw_Transaction_And_Sign_bitcoin = (
        Create_Raw_Transaction_And_Sign_bitcoin()
    )
    frm_pub_address: str = (
    ...
    signed_tx, coin = (
        create_raw_transaction_and_sign_bitcoin.create_raw_transaction_and_sign(
            frm_pub_address=frm_pub_address,
            frm_pub_address_priv_key=frm_pub_address_priv_key,
            to_pub_address=to_pub_address,
            print_result=print_result,
