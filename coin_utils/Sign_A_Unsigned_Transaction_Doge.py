...
class Sign_A_Unsigned_Transaction_Doge:
    def __init__(
        self,
    ):
...
async def test():
    ...
    sign_a_unsigned_transaction_doge: Sign_A_Unsigned_Transaction_Doge = (
        Sign_A_Unsigned_Transaction_Doge()
    )
    singed_tx: Optional[Tx] = None
    ...
    try:
        ...
        singed_tx, signed_tx_serialized = (
            await sign_a_unsigned_transaction_doge.sign_unsigned_transaction(
                unsigned_tx_serialized=unsigned_tx_serialized,
                privkey=privkey,
                print_to_terminal=print_to_terminal,
            )
