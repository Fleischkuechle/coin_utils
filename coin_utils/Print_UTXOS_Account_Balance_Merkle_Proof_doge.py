from Print_UTXOS_Account_Balance_Merkle_Proof_helper import (
    Print_UTXOS_Account_Balance_Merkle_Proof_helper,
)


class Print_UTXOS_Account_Balance_Merkle_Proof_doge:
    def __init__(
        self,
        testnet: bool = False,
    ):
    ...
    def print_account_balance(self, pub_address: str = ""):
        ...
        self.print_account_balance_helper.balance_online_lookup_merkle_proof(
...
if __name__ == "__main__":
    print_UTXOS_account_balance_merkle_proof_doge: (
        Print_UTXOS_Account_Balance_Merkle_Proof_doge
    ) = Print_UTXOS_Account_Balance_Merkle_Proof_doge()
