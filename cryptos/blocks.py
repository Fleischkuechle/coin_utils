...
def mk_merkle_proof(merkle_root: bytes, hashes: List[str], index: int) -> MerkleProof:
    ...
    try:
        ...
        return {"tx_hash": tx_hash, "siblings": [], "proven": False}


def verify_merkle_proof(
    tx_hash: str, merkle_root: bytes, hashes: List[str], index: int
) -> MerkleProof:
    ...
    return {"tx_hash": tx_hash, "proven": proven and h == merkle_root}
