...
def main():
    ...
    if coin.segwit_supported:
        p2wpkh_p2sh_wif_compressed = coin.encode_privkey(
            priv, "wif_compressed", script_type="p2wpkh-p2sh"
        )
        print(f"P2WPKH-P2SH wif compressed: {p2wpkh_p2sh_wif_compressed}")
        p2wpkh_p2sh_compressed_address = coin.privtop2wpkh_p2sh(
            p2wpkh_p2sh_wif_compressed
        )
        ...
        assert (
            p2wpkh_p2sh_compressed_address
            == p2wpkh_p2sh_address2
            == p2wpkh_p2sh_compressed_address2
            == coin.privtoaddr(p2wpkh_p2sh_wif_compressed)
        )

        p2wpkh_wif = coin.encode_privkey(priv, "wif", script_type="p2wpkh")
        p2wpkh_wif_compressed = coin.encode_privkey(
            priv, "wif_compressed", script_type="p2wpkh"
        )
        ...
        native_segwit_compressed_address = coin.privtosegwitaddress(
            p2wpkh_wif_compressed
        )
        ...
        native_segwit_compressed_address2 = coin.pubtosegwitaddress(
