...
class TestBitcoinTestnet(BaseSyncCoinTestCase):
    ...
    unspent_addresses: List[str] = [
        "ms31HApa3jvv3crqvZ3sJj7tC5TCs61GSA",
        "2MwHtiGJJqcFgNnbCu1REVy5ooDEeAAFXMy",
        "tb1qjap2aae2tsky3ctlh48yltev0sjdmx92yk76wq",
    ]
    unspent: List[ElectrumXTx] = [
        {
            "tx_hash": "1d69dd7a23f18d86f514ff7d8ef85894ad00c61fb29f3f7597e9834ac2569c8c",
            "tx_pos": 0,
            "height": 1238008,
            "value": 180000000,
    ...
    unspents: List[ElectrumXTx] = [
        ...
        {
            "tx_hash": "70bd4ce0e4cf2977ab53e767865da21483977cdb94b1a36eb68d30829c9c392f",
            "tx_pos": 1,
            "height": 1275633,
            "value": 173980000,
    ...
    histories: List[ElectrumXTx] = [
        ...
        {
            "tx_hash": "e25d8f4036e44159b0364b45867e08ae47a57dda68ba800ba8abe1fb2dc54a40",
            "height": 1275633,
            "address": "2MwHtiGJJqcFgNnbCu1REVy5ooDEeAAFXMy",
        },
        {
    ...
    txinputs: List[TxOut] = [
        # {
        #     "output": "1b8ae7a7a9629bbcbc13339bc29b258122c8d8670c54e6883d35c6a699e23a33:1",
        #     "value": 190453372316,
        # },
        {
            "address": "1b8ae7a7a9629bbcbc13339bc29b258122c8d8670c54e6883d35c6a699e23a33:1",
            "value": 190453372316,
        }
    ]
    raw_tx: str = (
        ""
    )
